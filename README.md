...
![Interoperability Diagram](./assets/Interoperability%20Diagram.png)
...
- **Verifies Hedera Admin Signature over (Token ID + User Address)**  
...
- **Verifies User Signature over User Operation**
...
- **Verifies User Signature over (Paymaster Address + Nonce)**
